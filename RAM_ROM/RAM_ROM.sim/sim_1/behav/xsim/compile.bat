...
REM
REM Generated by Vivado on Thu Jan 22 22:52:31 +0600 2026
...
echo "xvlog --incr --relax -prj SINGLE_PORT_RAM_tb_vlog.prj"
call xvlog  --incr --relax -prj SINGLE_PORT_RAM_tb_vlog.prj -log xvlog.log
